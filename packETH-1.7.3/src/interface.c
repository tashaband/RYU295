...
create_window1 (void)
{
  ...
  gtk_container_add (GTK_CONTAINER (toolbar1), toolitem21);

  button92 = gtk_button_new ();
  gtk_widget_show (button92);
  gtk_container_add (GTK_CONTAINER (toolitem21), button92);

  image2 = create_pixmap (window1, "donate.xpm");
  gtk_widget_show (image2);
  gtk_container_add (GTK_CONTAINER (button92), image2);
  ...
  gtk_box_pack_start (GTK_BOX (vbox82), hbox1503, FALSE, TRUE, 10);
  ...
  label398 = gtk_label_new (_(" Message body (optional 4 bytes) 0x: "));
  ...
  gtk_widget_set_size_request (entry214, 158, -1);
  gtk_entry_set_max_length (GTK_ENTRY (entry214), 8);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry214), 8226);

  hbox1505 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox1505);
  ...
  label243 = gtk_label_new (_("Number of packets to send ( 0 - 9999999 ) : "));
  ...
  gtk_box_pack_start (GTK_BOX (vbox60), hseparator9, FALSE, FALSE, 5);

  hbox1502 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox1502);
  gtk_box_pack_start (GTK_BOX (vbox60), hbox1502, TRUE, FALSE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox60), hbox1501, TRUE, FALSE, 5);
  ...
  gtk_box_pack_start (GTK_BOX (vbox60), hbox114, TRUE, FALSE, 0);
...
create_about_dialog (void)
{
  ...
  label275 = gtk_label_new (_("packETH - 1.7"));
